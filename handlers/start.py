...
WELCOME_TEXT = (
    ...
    "Весь основной функционал — тесты, профиль, рейтинги — на сайте. "
    "Чтобы начать, нажмите «🌐 Перейти на сайт» ниже.\n\n"
    "Остальные кнопки: 🏆/🏢 рейтинги пользователей и заведений, "
    "🏠 если уже связаны с заведением, 👤 общая статистика и список "
    "ваших заведений, 💼 вакансии, ❓ помощь с подробностями."
)
